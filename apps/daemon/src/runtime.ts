...
/**
 * `GET /linkcode` identity probe. `null` — by contract, not a swallowed error — means "not a
 * linkcode daemon" (connection refused, timeout, non-200, or a body that fails the schema).
 */
