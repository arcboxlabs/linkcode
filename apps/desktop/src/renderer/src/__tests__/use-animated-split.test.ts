import type { SplitTransitionState } from '@renderer/shell/layout/use-animated-split';
import { reconcileTransition } from '@renderer/shell/layout/use-animated-split';
