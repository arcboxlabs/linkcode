...
import { APP_ID, APP_NAME, STORAGE_DIR_NAME } from './constants';
...
// STORAGE_DIR_NAME is the brand's own storage universe (equal to APP_NAME on default builds);
// resolving it here, before any other module captures a path, is what keeps brands isolated.
