 ...
 *
 * Mounted twice on purpose: as the host's Settings tab, and as the root `/settings` route. Nothing
 * here is host-scoped, and the root mount is what keeps it reachable with no host registered at
 * all — the tab alone would hide "Manage hosts" behind having a host already. */
