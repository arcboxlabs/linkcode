 ...
 * needed) and no disclosure chevron, per MD3. The dot speaks Material roles — MD3 has no
 * success/warning — running reads as the active accent, waiting states as tertiary. */
