...
/** This app pins react/react-dom to the version RN bundles (AGENTS.md), so its copies are nested
 * instead of hoisted. Left alone, a hook under test resolves the pinned copy while
