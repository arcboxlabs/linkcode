...
/** Reasoning-effort levels. `max` is deliberately absent: the live-switch channel adapters use
 * (Claude's flag-settings layer) only accepts these four, so the contract stays switchable. */
