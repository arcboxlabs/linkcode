...
export const SHOWCASE_MARKDOWN_CONTENT = textBlock(
  [
    ...
    '',
    'Link icons: [Wikipedia](https://en.wikipedia.org/wiki/Arknights) carries a web icon, [@Computer](plugin://computer-use@openai-bundled) a plugin chip, [$github:github](/mock/linkcode/skills/github/SKILL.md) a skill chip, [transport.ts:41](/mock/linkcode/packages/foundation/transport/src/transport.ts:41) a file chip, and inline code `docs/ARCHITECTURE.md` upgrades to the same chip.',
    '',
    '```ts',
