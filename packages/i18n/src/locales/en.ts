...
export const en = {
  ...
  settings: {
    ...
    agents: {
      ...
      typeOauth: 'Sign-in',
      accountSecret: 'Key / token',
      accountBaseUrl: 'Endpoint URL (optional)',
      baseUrlPlaceholder: 'https://…',
      accountProtocol: 'Protocol (optional)',
      protocolNone: 'Default',
      accountModel: 'Default model (optional)',
      remove: 'Remove',
      activeAccount: 'Use account',
      accountNone: 'Default (sign-in / environment)',
    },
    providers: {
