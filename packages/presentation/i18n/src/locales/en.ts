...
export const en = {
  ...
  workbench: {
    ...
    automations: {
      ...
      noHarness: 'No harness is available. Complete setup in Settings first.',
      removedDraft: 'This task was deleted. You can still copy your changes, but cannot save them.',
      ...
      agentLabel: 'Agent',
      cwdLabel: 'Project',
      customDirectory: 'Other directory…',
      ...
      schedule: {
        ...
        onDay: 'Day {day}',
        maxRuns: 'Stop after this many runs',
        expiresAt: 'Stop at (local time zone)',
        never: 'No limit',
        new: 'New schedule',
        ...
        misfireLabel: 'If a scheduled time is missed',
        misfire: {
      ...
      loop: {
        verification: 'How to check completion',
        verificationMethods: {
          agent: 'Describe success',
          commands: 'Run check commands',
          both: 'Commands and success criteria',
        },
        stopping: 'Stopping…',
        timedOut: 'Check timed out',
        noOutput: 'No output',
        new: 'New loop',
        createSubmit: 'Start',
        empty: 'No loops yet',
