...
export const en = {
  ...
  settings: {
    ...
    providers: {
      ...
      accountDefault: 'Shown in the model menu · used when no account is named',
      accountEnabled: 'Shown in the model menu · “{label}” used when none is named',
      accountEnabledNoDefault: 'Shown in the model menu · follows the CLI login when none is named',
      accountDisabled: 'Hidden from this agent’s model menu',
      setDefaultAccount: 'Use as default account',
      clearDefaultAccount: 'Stop using as default account',
