...
export const en = {
  ...
  workbench: {
    ...
    message: {
      ...
      copied: 'Copied',
      edit: 'Edit',
      editUnavailable: 'This message cannot be branched yet',
      ...
      editDialogTitle: 'Edit prompt and create a branch',
      editDialogDescription:
        'A new conversation starts before this message. The original conversation remains unchanged.',
      editPromptLabel: 'Prompt',
      editFileStateWarning:
        'The branch keeps the current file state. Files are not restored to how they were when this message was sent.',
      editCancel: 'Cancel',
      editCreate: 'Create branch',
      editCreating: 'Creating…',
      editError: 'Failed to create branch: {message}',
      showMore: 'Show more',
      showLess: 'Show less',
