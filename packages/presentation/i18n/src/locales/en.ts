...
export const en = {
  ...
  workbench: {
    ...
    conversation: {
      ...
      thinking: 'Thinking…',
      thought: 'Thought',
      thoughtDuration: 'Thought for {seconds, plural, one {# second} other {# seconds}}',
    ...
    activityRun: {
      ...
      failed: '{count, plural, one {An action failed} other {# actions failed}}',
      failedMany: 'Some actions failed',
      ariaLabel: 'Activity details: {label}',
    },
    message: {
      copy: 'Copy',
      copied: 'Copied',
    ...
    resources: {
      ...
      open: 'Open',
      download: 'Download',
      reference: 'Reference in thread',
      remove: 'Remove from task/thread',
      operationFailed: 'Resource operation failed',
      tooLarge: '{name} exceeds the 8 MiB limit',
    ...
    panel: {
      ...
      simulatorConnecting: 'Connecting to screen…',
      ...
      simulatorAddDevice: 'Add a device',
      simulatorCloseDevice: 'Close this device',
      simulatorDeviceCap: 'A thread can use at most 4 devices at once',
      ...
      simulatorAttach: 'Attach simulator',
      simulatorDetached: 'Detached — the device is still running',
      simulatorScreenshot: 'Save screenshot',
      simulatorRecord: 'Record screen',
      simulatorStopRecording: 'Stop recording',
    ...
    usageReport: {
      ...
      lines: 'Lines changed',
      tokens: 'tokens',
      rateLimits: 'Plan limits',
      rateLimitsUnavailable: 'No plan rate-limit information is available for this account.',
      window: 'Limit window',
      windowMinutes: '{count}-minute window',
      unavailable: 'Unavailable',
      resets: 'Resets {date}',
      lastDay: 'Last 24 hours attribution',
      lastWeek: 'Last 7 days attribution',
      attributionEmpty: 'No skill, MCP, agent, or plugin attribution reported.',
      skill: 'Skill',
      mcp: 'MCP',
      agent: 'Agent',
      plugin: 'Plugin',
    ...
    sidebar: {
      ...
      account: 'Account',
      billingBalance: 'Available balance {currency} {amount}',
    ...
    preview: {
      ...
      browser: {
        ...
        downloadCompleted: 'Downloaded {filename}',
  ...
  settings: {
    ...
    plugins: {
      ...
      hint: "Plugins come from Claude Code's and Codex's own marketplaces and may bundle skills, commands, or MCP tool servers; whether they can be toggled here depends on the agent.",
      ...
      enabledReadOnly: 'Enabled · managed by the agent',
      disabledReadOnly: 'Disabled · managed by the agent',
      scope: {
        user: 'User',
        project: 'Project',
        local: 'Local',
      ...
      componentCount: {
        ...
        command: '{count, plural, one {# command} other {# commands}}',
        agent: '{count, plural, one {# agent} other {# agents}}',
        hook: '{count, plural, one {# hook} other {# hooks}}',
        'mcp-server': '{count, plural, one {# MCP server} other {# MCP servers}}',
        'lsp-server': '{count, plural, one {# LSP server} other {# LSP servers}}',
        'output-style': '{count, plural, one {# output style} other {# output styles}}',
        channel: '{count, plural, one {# channel} other {# channels}}',
      ...
      mcp: {
        ...
        customHint:
          'MCP is the protocol that connects agents to external tools and data. Servers you add here are yours; secrets stay in the local daemon and never return to clients.',
        pluginProvidedTitle: 'Plugin-provided MCP servers',
        pluginProvidedHint: 'Enabled together with their plugin — manage them on the Plugins tab.',
        ...
        form: {
          ...
          transport: 'Transport',
          transportLocked:
            'The transport cannot change; remove the server and re-add it (secrets must be re-entered).',
          command: 'Command',
          args: 'Arguments (one per line)',
          url: 'URL',
          secretsEnv: 'Environment variables',
          secretsHeaders: 'Headers',
          secretKey: 'Key',
          secretValue: 'Value',
          configured: 'Configured · leave blank to keep',
          addSecret: 'Add row',
          removeSecret: 'Remove key',
          restoreSecret: 'Keep key',
          save: 'Save',
          cancel: 'Cancel',
        },
      },
    ...
    billing: {
      title: 'Billing',
      signedOut: 'Sign in to LinkCode Cloud to view your balance and manage billing.',
      signIn: 'Sign in to LinkCode Cloud',
      loadError: 'Failed to load billing: {message}',
      organizationHint: 'Current organization: {organization}',
      purchaseForbidden:
        'You can view billing for this organization, but only an owner or admin can purchase credits.',
      available: 'Available balance',
      reserved: 'Reserved balance',
      reservedHint:
        'Requests reserve credit for their maximum token count. Any unused amount is released after settlement.',
      creditPacks: 'Credit packs',
      offersEmpty: 'No credit packs are available right now.',
      creditsIncluded: 'Includes {currency} {amount} in credits',
      buy: 'Buy',
      topUpAmount: 'Custom top-up amount (USD)',
      topUp: 'Top up',
      topUpHint: 'Minimum {minimum}; {fee}% non-refundable processing fee applies.',
      subscription: 'Subscription',
      subscriptionUnavailable:
        'Cloud does not expose subscription status yet. Manage an existing subscription in the billing portal.',
      manageSubscription: 'Manage subscription',
      portalUnavailable:
        'This organization does not have a billing profile yet. The portal becomes available after the first purchase.',
  ...
  mobile: {
    ...
    sessions: {
      ...
      searchEmpty: 'No matching threads',
    ...
    terminals: {
      ...
      emptyHint: 'Start a terminal to run commands on this host.',
      loadError: 'Unable to load terminals: {error}',
      createError: 'Unable to start terminal: {error}',
      retry: 'Try again',
      controlled: 'In use',
      newTerminal: 'New terminal',
      cwdLabel: 'Working directory',
      cwdPlaceholder: 'Optional — host default',
