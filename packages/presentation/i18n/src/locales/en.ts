...
export const en = {
  ...
  settings: {
    ...
    plugins: {
      ...
      linkcode: {
        hint: "LinkCode's own plugin marketplace: the local daemon refreshes the catalog, and a plugin's declared settings are filled in here after install; secrets stay on this machine and never return to clients.",
        installedTitle: 'Installed',
        installedEmpty: 'No LinkCode plugins installed yet — pick one from a marketplace below.',
        noMarketplaces: 'No marketplaces configured yet.',
        catalogEmpty: 'This marketplace has no plugins yet.',
      ...
      mcp: {
        ...
        form: {
          ...
          mailTemplateNone: 'None — start from scratch',
          template163: '163 mailbox',
          templateQq: 'QQ mailbox',
          templateExmail: 'Tencent Exmail',
        },
      },
    },
    historyImport: {
    ...
    providers: {
      ...
      linkCodeGatewayOptIn:
        'Uses your LinkCode credits. After adding the account, choose which Gateway models to offer.',
      ...
      copySecret: 'Copy',
      endpoint: 'Endpoint',
      protocols: 'Protocol shapes',
      accountModel: 'Models',
      models: {
        label: 'Models',
        hint: 'Fetch this service’s model list and tick the ones you want; only ticked models are offered in the composer.',
        hintUnlistable: 'This endpoint serves no model list — add model ids by hand.',
        refresh: 'Fetch list',
      ...
      accountDisabled: 'Hidden from this agent’s model menu',
      ...
      serviceHint: {
        ...
        'cloudflare-gateway': 'Compatibility gateway, needs Account / Gateway ID',
        'cloudflare-anthropic':
          'Pass-through gateway, needs an Anthropic key and Account / Gateway ID',
    ...
    billing: {
      title: 'Usage & billing',
      description: 'View the LinkCode Credits available to the active organization.',
      hostedHint:
