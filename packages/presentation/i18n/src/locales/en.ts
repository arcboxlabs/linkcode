...
export const en = {
  ...
  workbench: {
    ...
    apiKeyLogin: {
      title: 'Add an API key for {agent}',
      hint: "Paste a relay or gateway API key and its base URL. It is saved as a pool account and bound as this agent's active one.",
      defaultLabel: '{agent} relay',
      labelField: 'Name',
      baseUrl: 'Base URL',
      baseUrlPlaceholder: 'https://…',
      credentialType: 'Credential type',
      credentialApiKey: 'API key (x-api-key)',
      credentialAuthToken: 'Auth token (Bearer)',
      secret: 'Secret',
      protocol: {
        field: 'Protocol',
        anthropic: 'Anthropic',
      ...
      model: 'Default model',
      modelPlaceholder: "Leave empty to use the agent's default",
      detect: 'Detect models',
      detectCount: '{count} models detected',
      detectEmpty: 'The endpoint returned no models',
      detectNeedsEndpoint: 'Enter a valid base URL and secret first',
  ...
  settings: {
    ...
    providers: {
      ...
      setup: {
        title: 'Add a provider for {agent}',
        hint: 'Choose how you want to use this agent.',
        subscription: 'Login with subscription',
        subscriptionHint: 'Use your existing {agent} subscription.',
        subscriptionTitle: 'Login to {agent} with subscription',
        apiKey: 'Add API key',
        apiKeyHint: 'Use a direct API, relay, or gateway endpoint.',
