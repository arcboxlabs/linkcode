export const zhCN = {
  ...
  workbench: {
    ...
    sidebar: {
      ...
      account: '账户',
      billingBalance: '可用余额 {currency} {amount}',
      manageAccount: '管理账户',
      signOut: '退出登录',
  ...
  settings: {
    ...
    plugins: {
      ...
      tabMcp: 'MCP',
      tabSkills: '技能',
      discoveryFailed: '无法读取 {provider} 的插件：{reason}',
      discoveryFailedUnknown: '扫描失败',
      runtimeMissing: '未检测到 {provider}，安装后即可在这里管理它的插件。',
    ...
    billing: {
      title: '账单',
      signedOut: '查看余额和管理账单前，请先登录 LinkCode Cloud。',
      signIn: '登录 LinkCode Cloud',
      loadError: '加载账单失败：{message}',
      organizationHint: '当前组织：{organization}',
      purchaseForbidden: '你可以查看该组织的账单，但只有所有者或管理员可以购买额度。',
      available: '可用余额',
      reserved: '预留余额',
      reservedHint: '请求会按最大 token 数预留额度；结算后未使用的部分会自动释放。',
      creditPacks: '额度包',
      offersEmpty: '当前没有可购买的额度包。',
      creditsIncluded: '包含 {currency} {amount} 额度',
      buy: '购买',
      topUpAmount: '自定义充值金额（USD）',
      topUp: '充值',
      topUpHint: '最低 {minimum}；另收 {fee}% 处理费，处理费不可退款。',
      subscription: '订阅',
      subscriptionUnavailable: 'Cloud 暂未提供订阅状态读取接口；可前往支付门户管理已有订阅。',
      manageSubscription: '管理订阅',
      portalUnavailable: '该组织还没有支付账户。完成首次购买后即可使用支付门户。',
      orders: '订单记录',
      ordersEmpty: '暂无订单。',
