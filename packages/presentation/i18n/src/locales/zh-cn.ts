export const zhCN = {
  ...
  settings: {
    ...
    plugins: {
      ...
      linkcode: {
        hint: 'LinkCode 自有插件市场：目录由本机 daemon 刷新；插件声明的配置项在安装后于此填写，密钥只保存在本机，不会回传。',
        installedTitle: '已安装',
        installedEmpty: '还没有安装任何 LinkCode 插件；从下方市场目录挑一个。',
        noMarketplaces: '还没有配置任何插件市场。',
        allMarketplacesDisabled: '已配置的插件市场都已停用。',
        catalogEmpty: '这个市场暂时没有可用的插件。',
        refresh: '刷新目录',
        installed: '已安装',
        installedNewer: '已安装更新的版本',
