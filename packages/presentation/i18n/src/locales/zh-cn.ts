export const zhCN = {
  ...
  workbench: {
    ...
    message: {
      ...
      copied: '已复制',
      edit: '编辑',
      editUnavailable: '该消息暂时无法创建分支',
      editUnsupported: '当前智能体不支持编辑历史提示词',
      editBusy: '请等待当前智能体完成后再编辑',
      editDialogTitle: '编辑提示词并创建分支',
      editDialogDescription: '将从这条消息之前创建一个新对话，原对话不会改变。',
      editPromptLabel: '提示词',
      editFileStateWarning: '新分支会保留当前文件状态，不会恢复到发送此消息时。',
      editCancel: '取消',
      editCreate: '创建分支',
      editCreating: '正在创建…',
      editError: '创建分支失败：{message}',
      showMore: '展开',
      showLess: '收起',
      goodResponse: '有帮助',
      badResponse: '没帮助',
