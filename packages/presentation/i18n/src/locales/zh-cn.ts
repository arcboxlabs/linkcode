export const zhCN = {
  ...
  settings: {
    ...
    plugins: {
      hint: '管理智能体可用的插件、技能与 MCP 服务器。凭证只保存在本机 daemon 中。',
      loadError: '无法加载插件设置：{message}',
      tabPlugins: '插件',
      tabMcp: 'MCP',
      tabSkills: '技能',
      searchPlaceholder: '搜索',
      searchEmpty: '没有匹配的结果。',
      skillsEmpty: '技能管理即将推出。',
      ...
      customHint: '导入你自己的 MCP 服务器。凭证只保存在本机 daemon，仅注入受支持的智能体会话。',
      customEmpty: '尚未导入任何自定义 MCP 服务器。',
      customAdd: '添加服务器',
      customAddTitle: '添加自定义 MCP 服务器',
      customEmptyDetail: '（无）',
      customSecretKeys: '凭证：{keys}',
      customRemove: '移除{name}',
      customCancel: '取消',
      customSaveError: '无法保存 MCP 服务器。',
      customForm: {
        name: '名称',
        nameHint: '注入到智能体的服务器标识，只能包含字母、数字、- 和 _。',
        nameError: '名称只能包含字母、数字、- 和 _。',
        transport: '传输方式',
        ...
        args: '参数',
        env: '环境变量',
        envError: '每行需为 KEY=VALUE 格式。',
        url: '地址',
        headers: '请求头',
        headersError: '每行需为「名称: 值」格式。',
        secretHint: '每行一个键值对；值仅发送到本机 daemon，之后不会再读回。',
      },
    },
    notifications: {
      title: '通知',
