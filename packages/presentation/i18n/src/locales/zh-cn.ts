export const zhCN = {
  ...
  workbench: {
    ...
    apiKeyLogin: {
      title: '为 {agent} 添加 API Key',
      hint: '填入中转站或网关的 API Key 与 Base URL。保存后会作为账号存入账号池，并绑定为该 agent 的活跃账号。',
      defaultLabel: '{agent} 中转站',
      labelField: '名称',
      baseUrl: 'Base URL',
      ...
      model: '默认模型',
      modelPlaceholder: '留空则用 agent 默认模型',
      detect: '检测模型',
      detectCount: '检测到 {count} 个模型',
      detectEmpty: '该端点没有返回任何模型',
      detectNeedsEndpoint: '请先填写有效的 Base URL 与密钥',
      detectFailed: '检测失败',
      saveFailed: '保存失败',
      cancel: '取消',
      save: '保存并使用',
  ...
  settings: {
    ...
    providers: {
      ...
      chooseService: '选择服务商',
      setup: {
        title: '为 {agent} 添加 Provider',
        hint: '选择你想使用此智能体的方式。',
        subscription: '使用订阅登录',
        subscriptionHint: '使用现有的 {agent} 订阅账号。',
        subscriptionTitle: '使用订阅登录 {agent}',
        apiKey: '添加 API Key',
        apiKeyHint: '使用 API 直连、中转站或网关端点。',
        chooseMethod: '选择其他方式',
      },
      group: {
        subscription: '订阅',
