export const zhCN = {
  ...
  settings: {
    ...
    plugins: {
      hint: '为智能体配置可选的外部工具与访问凭证。凭证只保存在本机 daemon 中。',
      managedUnavailable:
        '云端连接与工具交付尚未开放。你可以先保存 GitHub 个人凭证；在服务支持上线前，智能体还不能使用这些工具。',
      ...
      connectionFallback: 'GitHub 访问',
      githubConnectionDefault: '我的 GitHub',
      addTitle: '添加 GitHub 访问',
      editTitle: '编辑 GitHub 访问',
      removeTitle: '移除“{name}”？',
      removeDescription: '凭证将从本机删除，使用它的工具也会被停用。此操作不可撤销。',
      removeConfirm: '移除',
      cancel: '取消',
      add: '添加',
      save: '保存',
      saveError: '无法保存 GitHub 访问。',
      form: {
        label: '名称',
        credentialType: '凭证类型',
        secret: '密钥或令牌',
        secretHint: '凭证仅发送到本机 daemon，不会从设置接口读回。',
        secretKeepPlaceholder: '留空以保留已保存的凭证',
        secretKeepHint: '出于安全考虑，已保存的值不会显示。输入新值会替换它。',
      },
      units: {
        githubRead: {
          label: 'GitHub 只读能力',
