  ...
  return (
    ...
    >
      <button
        type="button"
        title={title ?? label}
        className="flex h-full min-w-0 flex-1 items-center gap-1.5 px-2 text-left outline-none transition-transform duration-(--motion-fast) focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-inset active:scale-[0.98]"
        onClick={onSelect}
      >
      ...
      <button
        ...
        title={closeLabel}
        className={cn(
          'mr-1 size-4 shrink-0 items-center justify-center rounded-sm text-muted-foreground opacity-50 outline-none transition-transform duration-(--motion-fast) hover:bg-muted hover:text-foreground focus-visible:ring-2 focus-visible:ring-ring active:scale-90 group-hover:opacity-100',
