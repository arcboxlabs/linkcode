...
function StepFunGlyph(props: React.SVGProps<SVGSVGElement>): React.ReactNode {
  return (
    <svg
      viewBox="0 0 24 24"
      fill="currentColor"
...
const SERVICE_GLYPHS: Record<string, (props: React.SVGProps<SVGSVGElement>) => React.ReactNode> = {
