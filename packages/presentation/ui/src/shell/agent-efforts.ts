...
/** The per-kind effort options narrowed to what the picked model supports, when the catalog
 * carries per-model levels; without capability data the full per-kind table stands. */
