...
export interface AgentAdapter {
  ...
  /** Pre-session picker data (models / approval tiers) for the new-session surface. Like the
   * history reads, this runs on never-started factory instances — no `start()` state allowed. */
